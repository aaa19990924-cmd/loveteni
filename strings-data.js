...
const STRING_DATABASE = [
  ...
  { id: 'yonex-polytour-pro-125-red', brand: 'YONEX', model: 'POLYTOUR PRO 125 フラッシュレッド', type: 'ポリエステル', gauge: '1.25mm', length: '12m', color: 'フラッシュレッド', year: 2024, concept: 'POLYTOUR PROの赤カラーバリエーション', searchKeyword: 'ヨネックス POLYTOUR PRO 125 フラッシュレッド' },
