...
const STRING_DATABASE = [
  ...
  { id: 'prince-lightning-xx-130', brand: 'Prince', model: 'LIGHTNING XX 16', type: 'ナイロン', gauge: '1.30mm', gaugeNum: 1.30, length: '12m', color: 'ナチュラル', year: 2024, form: 'both', concept: 'Powerfoil技術採用の高弾力モノフィラメント・オールラウンド性能', searchKeyword: 'プリンス LIGHTNING XX 16 130' },
  ...
  { id: 'dunlop-iconic-all-125', brand: 'Dunlop', model: 'ICONIC ALL 125', type: 'マルチフィラメント', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'ナチュラル', year: 2024, form: 'both', concept: 'パワーとコントロールのバランスを取ったDunlopのオールラウンドマルチ', searchKeyword: 'ダンロップ ICONIC ALL 125 マルチ' },
