...
const STRING_DATABASE = [
  ...
  // ========== YONEX ==========
  { id: 'yonex-polytour-pro-125', brand: 'YONEX', model: 'POLYTOUR PRO 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'グラファイト', colors: ['グラファイト', 'フラッシュイエロー', 'ブルー', 'パープル'], year: 2024, form: 'both', concept: 'バランスの取れたツアーポリ', searchKeyword: 'ヨネックス POLYTOUR PRO 125 グラファイト' },
  { id: 'yonex-polytour-pro-120', brand: 'YONEX', model: 'POLYTOUR PRO 120', type: 'ポリエステル', gauge: '1.20mm', gaugeNum: 1.20, length: '12m', color: 'グラファイト', colors: ['グラファイト', 'フラッシュイエロー', 'ブルー', 'パープル'], year: 2024, form: 'both', concept: '細め1.20mm・よりシャープな打球感のPOLYTOUR PRO', searchKeyword: 'ヨネックス POLYTOUR PRO 120' },
  { id: 'yonex-polytour-pro-130', brand: 'YONEX', model: 'POLYTOUR PRO 130', type: 'ポリエステル', gauge: '1.30mm', gaugeNum: 1.30, length: '12m', color: 'グラファイト', colors: ['グラファイト', 'フラッシュイエロー', 'ブルー', 'パープル'], year: 2024, form: 'both', concept: '太めPOLYTOUR PROで耐久性アップ', searchKeyword: 'ヨネックス POLYTOUR PRO 130' },
  ...
  { id: 'yonex-polytour-rev-120', brand: 'YONEX', model: 'POLYTOUR REV 120', type: 'ポリエステル', gauge: '1.20mm', gaugeNum: 1.20, length: '12m', color: 'ブライトイエロー', colors: ['ブライトイエロー', 'ピンク'], year: 2024, form: 'both', concept: '細め1.20mm・よりシャープなスピン&コントロール', searchKeyword: 'ヨネックス POLYTOUR REV 120' },
  { id: 'yonex-polytour-spin-125', brand: 'YONEX', model: 'POLYTOUR SPIN 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'コバルトブルー', colors: ['コバルトブルー', 'ブラック'], year: 2025, form: 'both', concept: '2024-25新作・スナップバック特化でスピン量を大幅アップ', searchKeyword: 'ヨネックス POLYTOUR SPIN 125' },
  { id: 'yonex-polytour-spin-120', brand: 'YONEX', model: 'POLYTOUR SPIN 120', type: 'ポリエステル', gauge: '1.20mm', gaugeNum: 1.20, length: '12m', color: 'コバルトブルー', colors: ['コバルトブルー', 'ブラック'], year: 2025, form: 'both', concept: '細め1.20mm・より鋭いスピン&コントロール', searchKeyword: 'ヨネックス POLYTOUR SPIN 120' },
  { id: 'yonex-polytour-fire-120', brand: 'YONEX', model: 'POLYTOUR FIRE 120', type: 'ポリエステル', gauge: '1.20mm', gaugeNum: 1.20, length: '12m', color: 'レッド', year: 2024, form: 'both', concept: '鋭い球離れ・スピン+スナップバックのニュースタンダード', searchKeyword: 'ヨネックス POLYTOUR FIRE 120' },
  { id: 'yonex-polytour-fire-115', brand: 'YONEX', model: 'POLYTOUR FIRE 115', type: 'ポリエステル', gauge: '1.15mm', gaugeNum: 1.15, length: '12m', color: 'レッド', year: 2024, form: 'both', concept: '超細ゲージ1.15mm・最大スピンを追求', searchKeyword: 'ヨネックス POLYTOUR FIRE 115' },
  ...
  // ========== Gosen ==========
  { id: 'gosen-og-sheep-micro-125', brand: 'Gosen', model: 'OG-SHEEP MICRO 16L', type: 'ナイロン', gauge: '1.25mm', gaugeNum: 1.25, length: '12.2m', color: 'ナチュラル', colors: ['ナチュラル', 'ホワイト', 'ブラック'], year: 2023, form: 'both', concept: '学生定番。コスパ最強の鉄板ナイロン', searchKeyword: 'ゴーセン OG-SHEEP MICRO' },
  { id: 'gosen-og-sheep-micro-130', brand: 'Gosen', model: 'OG-SHEEP MICRO 16', type: 'ナイロン', gauge: '1.30mm', gaugeNum: 1.30, length: '12.2m', color: 'ナチュラル', colors: ['ナチュラル', 'ホワイト', 'ブラック'], year: 2023, form: 'both', concept: '太めOG-SHEEPで耐久性アップ', searchKeyword: 'ゴーセン OG-SHEEP MICRO 16' },
  { id: 'gosen-polylon-comfort-125', brand: 'Gosen', model: 'POLYLON COMFORT 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12.2m', color: 'ホワイト', year: 2024, form: 'both', concept: 'コスパに優れた柔らかポリ', searchKeyword: 'ゴーセン POLYLON COMFORT' },
  ...
  { id: 'gosen-polylon-ice-125', brand: 'Gosen', model: 'POLYLON ICE 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12.2m', color: 'クリア', colors: ['クリア', 'ブラック'], year: 2024, form: 'both', concept: 'Gosenの人気ポリ・クリアカラーが特徴的', searchKeyword: 'ゴーセン POLYLON ICE 125' },
  ...
  // ========== Dunlop ==========
  { id: 'dunlop-iconic-all-125', brand: 'Dunlop', model: 'ICONIC ALL 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'ナチュラル', year: 2024, form: 'both', concept: 'オールラウンドポリ・コントロールと耐久性のバランス', searchKeyword: 'ダンロップ ICONIC ALL 125' },
  ...
  { id: 'toalson-toughblade-130', brand: 'Toalson', model: 'TOUGH BLADE 130', type: 'ポリエステル', gauge: '1.30mm', gaugeNum: 1.30, length: '12m', color: 'ナチュラル', colors: ['ナチュラル', 'ブラック'], year: 2024, form: 'both', concept: '太めタフブレードで耐久性重視', searchKeyword: 'トアルソン TOUGH BLADE 130' },
  ...
  // ========== Prince ==========
  { id: 'prince-beast-xp-125', brand: 'Prince', model: 'BEAST XP 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'グリーン', year: 2024, form: 'both', concept: 'BEASTラケット専用開発・スピンとパワーの爆発力', searchKeyword: 'プリンス BEAST XP 125' },
  { id: 'prince-beast-xp-130', brand: 'Prince', model: 'BEAST XP 130', type: 'ポリエステル', gauge: '1.30mm', gaugeNum: 1.30, length: '12m', color: 'グリーン', year: 2024, form: 'both', concept: '太めBEAST XP・耐久性重視', searchKeyword: 'プリンス BEAST XP 130' },
  ...
  { id: 'prince-premier-control-125', brand: 'Prince', model: 'PREMIER CONTROL 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'ブラック', colors: ['ブラック', 'ナチュラル'], year: 2024, form: 'both', concept: 'コントロール重視ポリ・ナイロンに近い打感', searchKeyword: 'プリンス PREMIER CONTROL 125' },
  ...
  { id: 'gosen-g-tour3-125', brand: 'Gosen', model: 'G-TOUR 3 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12.2m', color: 'ブラック', colors: ['ブラック', 'イエロー'], year: 2024, form: 'both', concept: 'エントリーツアーポリ・柔らかくコントロール重視', searchKeyword: 'ゴーセン G-TOUR 3 125' },
  { id: 'gosen-g-spin3-124', brand: 'Gosen', model: 'G-SPIN 3 124', type: 'ポリエステル', gauge: '1.24mm', gaugeNum: 1.24, length: '12.2m', color: 'クリムゾンレッド', colors: ['クリムゾンレッド', 'ブラック'], year: 2024, form: 'both', concept: '17ゲージスピン特化ポリ・鮮やかな赤が特徴', searchKeyword: 'ゴーセン G-SPIN 3 124' },
  ...
  // ========== Dunlop (追加モデル) ==========
  { id: 'dunlop-explosive-bite-125', brand: 'Dunlop', model: 'EXPLOSIVE BITE 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'イエロー', colors: ['イエロー', 'ブラック'], year: 2024, form: 'both', concept: '食いつき重視・スピン量を最大化する角断面ポリ', searchKeyword: 'ダンロップ EXPLOSIVE BITE 125' },
  { id: 'dunlop-explosive-tour-125', brand: 'Dunlop', model: 'EXPLOSIVE TOUR 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'グレー', year: 2024, form: 'both', concept: 'ツアー向けコントロール&耐久性・プロ品質', searchKeyword: 'ダンロップ EXPLOSIVE TOUR 125' },
  ...
  { id: 'toalson-renkon-devil-spin-125', brand: 'Toalson', model: 'RENKON DEVIL SPIN 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'ブラック', colors: ['ブラック', 'レッド', 'ブルー'], year: 2024, form: 'both', concept: '蓮根断面の異形ポリ・国内最高クラスのスピン性能', searchKeyword: 'トアルソン れんこん デビルスピン RENKON 125' },
  { id: 'toalson-asterista-125', brand: 'Toalson', model: 'ASTERISTA 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'ホワイト', colors: ['ホワイト', 'ブラック', 'イエロー', 'レッド', 'ピンク', 'ブルー', 'グリーン', 'オレンジ', 'パープル'], year: 2024, form: 'both', concept: 'コスパ重視のスタンダードポリ・豊富なカラー展開', searchKeyword: 'トアルソン アスタリスタ ASTERISTA 125' },
  ...
  // ========== Prince (追加モデル) ==========
  { id: 'prince-lightning-xx-130', brand: 'Prince', model: 'LIGHTNING XX 130', type: 'ナイロン', gauge: '1.30mm', gaugeNum: 1.30, length: '12m', color: 'ブラック', colors: ['ブラック', 'ブルー', 'グリーン', 'レッド', 'シルバー', 'イエロー'], year: 2023, form: 'both', concept: '高弾力モノフィラメント・反発とパワーを重視', searchKeyword: 'プリンス LIGHTNING XX 130' },
  ...
  // ========== YONEX (追加3 - 新シリーズ) ==========
  { id: 'yonex-polytour-force-120', brand: 'YONEX', model: 'POLYTOUR FORCE 120', type: 'ポリエステル', gauge: '1.20mm', gaugeNum: 1.20, length: '12m', color: 'ブライトレッド', colors: ['ブライトレッド', 'ブラック'], year: 2025, form: 'both', concept: '2025年新作・細め1.20mmでパワーと食いつき両立', searchKeyword: 'ヨネックス POLYTOUR FORCE 120' },
  { id: 'yonex-polytour-force-125', brand: 'YONEX', model: 'POLYTOUR FORCE 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'ブライトレッド', colors: ['ブライトレッド', 'ブラック'], year: 2025, form: 'both', concept: 'パワーとコントロールのバランス型・2025年新シリーズ', searchKeyword: 'ヨネックス POLYTOUR FORCE 125' },
  { id: 'yonex-polytour-force-130', brand: 'YONEX', model: 'POLYTOUR FORCE 130', type: 'ポリエステル', gauge: '1.30mm', gaugeNum: 1.30, length: '12m', color: 'ブライトレッド', colors: ['ブライトレッド', 'ブラック'], year: 2025, form: 'both', concept: '太め1.30mmでパワーと耐久性を最大化', searchKeyword: 'ヨネックス POLYTOUR FORCE 130' },
  ...
  { id: 'gosen-polybreak-124', brand: 'Gosen', model: 'POLYBREAK 124', type: 'ポリエステル', gauge: '1.24mm', gaugeNum: 1.24, length: '12.2m', color: 'ブラック', colors: ['ブラック', 'ホワイト'], year: 2024, form: 'both', concept: '丸型コポリ・柔らかめでコントロール重視のリーズナブルポリ', searchKeyword: 'ゴーセン ポリブレイク POLYBREAK 124' },
  ...
  // ========== Kirschbaum (新ブランド) ==========
  { id: 'kirschbaum-pro-line-ii-125', brand: 'Kirschbaum', model: 'PRO LINE II 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'ブラック', colors: ['ブラック', 'レッド'], year: 2024, form: 'both', concept: 'プレストレッチ加工でテンション維持に優れるドイツ製コポリの定番', searchKeyword: 'Kirschbaum キルシュバウム PRO LINE II 125' },
  { id: 'kirschbaum-pro-line-ii-120', brand: 'Kirschbaum', model: 'PRO LINE II 120', type: 'ポリエステル', gauge: '1.20mm', gaugeNum: 1.20, length: '12m', color: 'ブラック', colors: ['ブラック', 'レッド'], year: 2024, form: 'both', concept: '細め1.20mmのPRO LINE II・スピン量アップ&繊細な打感', searchKeyword: 'Kirschbaum PRO LINE II 120' },
  { id: 'kirschbaum-pro-line-ii-rough-125', brand: 'Kirschbaum', model: 'PRO LINE II ROUGH 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'ブラック', colors: ['ブラック', 'レッド'], year: 2024, form: 'both', concept: 'PRO LINE IIにラフ加工を追加・スピンバイトを強化', searchKeyword: 'Kirschbaum PRO LINE II ROUGH 125' },
  { id: 'kirschbaum-max-power-125', brand: 'Kirschbaum', model: 'MAX POWER 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'シルバー', colors: ['シルバー', 'レッド', 'ホワイト'], year: 2024, form: 'both', concept: 'コントロールと耐久性を両立したベースラインプレーヤー向けコポリ', searchKeyword: 'Kirschbaum MAX POWER 125' },
  { id: 'kirschbaum-max-power-rough-125', brand: 'Kirschbaum', model: 'MAX POWER ROUGH 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'シルバー', colors: ['シルバー', 'レッド', 'ホワイト'], year: 2024, form: 'both', concept: 'MAX POWERにラフ加工・スピン量を強化したコントロールポリ', searchKeyword: 'Kirschbaum MAX POWER ROUGH 125' },
  { id: 'kirschbaum-xplosive-speed-123', brand: 'Kirschbaum', model: 'XPLOSIVE SPEED 123', type: 'ポリエステル', gauge: '1.23mm', gaugeNum: 1.23, length: '12m', color: 'ブラック', year: 2024, form: 'both', concept: '異形断面が生み出すスピン&比較的柔らかい打感を両立', searchKeyword: 'Kirschbaum XPLOSIVE SPEED 123' },
  ...
  { id: 'kirschbaum-evolution-125', brand: 'Kirschbaum', model: 'EVOLUTION 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'ブルー', year: 2024, form: 'both', concept: 'プレストレッチでコントロール精度を高めた上級者向けコポリ', searchKeyword: 'Kirschbaum EVOLUTION 125' },
  ...
  // ========== MSV (新ブランド) ==========
  { id: 'msv-focus-hex-127', brand: 'MSV', model: 'FOCUS HEX 127', type: 'ポリエステル', gauge: '1.27mm', gaugeNum: 1.27, length: '12m', color: 'シルバー', colors: ['シルバー', 'ブラック', 'ホワイト', 'レッド', 'スカイブルー', 'グリーン', 'イエロー'], year: 2024, form: 'both', concept: '六角断面スピンポリの元祖・ボールバイト抜群のドイツ製オリジナル', searchKeyword: 'MSV FOCUS HEX 127' },
  { id: 'msv-focus-hex-118', brand: 'MSV', model: 'FOCUS HEX 118', type: 'ポリエステル', gauge: '1.18mm', gaugeNum: 1.18, length: '12m', color: 'シルバー', colors: ['シルバー', 'ブラック', 'ホワイト', 'レッド', 'スカイブルー', 'グリーン', 'イエロー'], year: 2024, form: 'both', concept: '細め1.18mmのFOCUS HEX・スピン量と繊細さを極めた超細ゲージ', searchKeyword: 'MSV FOCUS HEX 118' },
  { id: 'msv-focus-hex-soft-125', brand: 'MSV', model: 'FOCUS HEX SOFT 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'グリーン', colors: ['グリーン', 'ブラック', 'ホワイト', 'レッド', 'スカイブルー', 'イエロー'], year: 2024, form: 'both', concept: '柔らかい素材の六角断面・スピンを保ちながら腕に優しい', searchKeyword: 'MSV FOCUS HEX SOFT 125' },
  { id: 'msv-focus-hex-38-125', brand: 'MSV', model: 'FOCUS HEX +38 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'ブラック', colors: ['ブラック', 'ホワイト', 'レッド'], year: 2024, form: 'both', concept: 'FOCUS HEXシリーズ最も柔らかい六角断面・コンフォート重視', searchKeyword: 'MSV FOCUS HEX +38 125' },
  ...
  { id: 'msv-co-focus-118', brand: 'MSV', model: 'CO.-FOCUS 118', type: 'ポリエステル', gauge: '1.18mm', gaugeNum: 1.18, length: '12m', color: 'ブラック', colors: ['ブラック', 'ホワイト', 'レッド', 'スカイブルー'], year: 2024, form: 'both', concept: '丸型コポリの細め・食いつきとコントロールに優れる薄ゲージポリ', searchKeyword: 'MSV CO-FOCUS 118' },
  { id: 'msv-hepta-twist-125', brand: 'MSV', model: 'HEPTA-TWIST 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'アンスラサイト', colors: ['アンスラサイト', 'ホワイト', 'レッド'], year: 2024, form: 'both', concept: '七角断面をねじった革新構造・強烈なスピンを生み出す異形ポリ', searchKeyword: 'MSV HEPTA-TWIST 125' },
  { id: 'msv-swift-comfort-125', brand: 'MSV', model: 'SWIFT COMFORT 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'ブラック', colors: ['ブラック', 'ホワイト'], year: 2024, form: 'both', concept: 'コンフォート優先の丸型コポリ・精密なコントロール感覚', searchKeyword: 'MSV SWIFT COMFORT 125' },
  ...
  { id: 'pacific-poly-force-125', brand: 'Pacific', model: 'Poly Force 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'オレンジ', colors: ['オレンジ', 'シルバー'], year: 2024, form: 'both', concept: '高モジュラスポリでコントロールと耐久性を両立する定番ポリ', searchKeyword: 'Pacific パシフィック Poly Force ポリフォース 125' },
  { id: 'pacific-poly-power-pro-125', brand: 'Pacific', model: 'Poly Power Pro 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'シルバー', colors: ['シルバー', 'ブラック', 'イエロー'], year: 2024, form: 'both', concept: '独自コーティングの高モジュラスポリ・コントロールと耐久性のフラッグシップ', searchKeyword: 'Pacific Poly Power Pro 125' },
  { id: 'pacific-x-force-125', brand: 'Pacific', model: 'X Force 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'オレンジ', year: 2024, form: 'both', concept: 'アグレッシブなプレーヤー向け・コントロールとスピンのポリ', searchKeyword: 'Pacific X Force 125' },
  { id: 'pacific-champ-tour-125', brand: 'Pacific', model: 'Champ Tour 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'シルバー', year: 2024, form: 'both', concept: '柔らかめ素材でフィールと耐久性を両立・長年愛される定番ポリ', searchKeyword: 'Pacific Champ Tour 125' },
  { id: 'pacific-ftx-128', brand: 'Pacific', model: 'FTX 128', type: 'マルチフィラメント', gauge: '1.28mm', gaugeNum: 1.28, length: '12m', color: 'ナチュラル', colors: ['ナチュラル', 'ホワイト'], year: 2024, form: 'both', concept: '2種のコポリフィラメントで衝撃吸収とテンション維持を両立するマルチ', searchKeyword: 'Pacific FTX 128 マルチ' },

  // ========== Signum Pro (新ブランド) ==========
  { id: 'signum-pro-firestorm-125', brand: 'Signum Pro', model: 'FIRESTORM 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'ゴールド', year: 2024, form: 'both', concept: 'ベレッティーニ使用・低テンションロスとコントロールのドイツ製フラッグシップ', searchKeyword: 'Signum Pro シグナムプロ FIRESTORM 125' },
  { id: 'signum-pro-poly-plasma-123', brand: 'Signum Pro', model: 'POLY PLASMA 123', type: 'ポリエステル', gauge: '1.23mm', gaugeNum: 1.23, length: '12m', color: 'パールオレンジ', year: 2024, form: 'both', concept: '広いゲージ展開のスピン&コントロールポリ・扱いやすい定番', searchKeyword: 'Signum Pro POLY PLASMA 123' },
  { id: 'signum-pro-poly-plasma-pure-123', brand: 'Signum Pro', model: 'POLY PLASMA PURE 123', type: 'ポリエステル', gauge: '1.23mm', gaugeNum: 1.23, length: '12m', color: 'パールオレンジ', year: 2024, form: 'both', concept: 'POLY PLASMAのコンフォート版・柔らかさと耐久性を向上', searchKeyword: 'Signum Pro POLY PLASMA PURE 123' },
  { id: 'signum-pro-plasma-hextreme-125', brand: 'Signum Pro', model: 'PLASMA HEXTREME 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'パールオレンジ', year: 2024, form: 'both', concept: '六角断面の強烈なボールバイトでスピン量を最大化', searchKeyword: 'Signum Pro PLASMA HEXTREME 125' },
  { id: 'signum-pro-hyperion-124', brand: 'Signum Pro', model: 'HYPERION 124', type: 'ポリエステル', gauge: '1.24mm', gaugeNum: 1.24, length: '12m', color: 'ブラック', year: 2024, form: 'both', concept: 'テンションロスを最小化する高反発コポリ・スピンとコントロールのバランス型', searchKeyword: 'Signum Pro HYPERION 124' },
  { id: 'signum-pro-tornado-123', brand: 'Signum Pro', model: 'TORNADO 123', type: 'ポリエステル', gauge: '1.23mm', gaugeNum: 1.23, length: '12m', color: 'アンスラサイト', year: 2024, form: 'both', concept: '七角断面のねじれ構造でスピンとコンフォートを両立', searchKeyword: 'Signum Pro TORNADO 123' },
  { id: 'signum-pro-thunderstorm-124', brand: 'Signum Pro', model: 'THUNDERSTORM 124', type: 'ポリエステル', gauge: '1.24mm', gaugeNum: 1.24, length: '12m', color: 'パープル', year: 2024, form: 'both', concept: '十角断面ねじれ構造・スピンとコントロールを極めたシグナムの革新作', searchKeyword: 'Signum Pro THUNDERSTORM 124' },
  { id: 'signum-pro-polaris-120', brand: 'Signum Pro', model: 'POLARIS 120', type: 'ポリエステル', gauge: '1.20mm', gaugeNum: 1.20, length: '12m', color: 'イエロー', year: 2024, form: 'both', concept: '細め1.20mmの高コンフォートコポリ・スピンと腕への優しさを両立', searchKeyword: 'Signum Pro POLARIS 120' },
  { id: 'signum-pro-fibercore-130', brand: 'Signum Pro', model: 'FIBERCORE 130', type: 'マルチフィラメント', gauge: '1.30mm', gaugeNum: 1.30, length: '12m', color: 'シルバー', year: 2024, form: 'both', concept: '低摩擦コーティングでテンション維持と打感を両立するコンフォートマルチ', searchKeyword: 'Signum Pro FIBERCORE 130 マルチ' },
  ...
  { id: 'weiss-cannon-ultra-cable-123', brand: 'Weiss Cannon', model: 'ULTRA CABLE 123', type: 'ポリエステル', gauge: '1.23mm', gaugeNum: 1.23, length: '12m', color: 'ブラック', colors: ['ブラック', 'ホワイト', 'イエロー'], year: 2024, form: 'both', concept: '四角断面がボールを捕まえる・スピン最重視のコポリ', searchKeyword: 'Weiss Cannon ULTRA CABLE 123' },
  { id: 'weiss-cannon-scorpion-122', brand: 'Weiss Cannon', model: 'SCORPION 122', type: 'ポリエステル', gauge: '1.22mm', gaugeNum: 1.22, length: '12m', color: 'ホワイト', year: 2024, form: 'both', concept: 'パワーと食いつきのバランス型コポリ・コントロールを保ちながら反発力を追加', searchKeyword: 'Weiss Cannon SCORPION 122' },
  ...
  { id: 'weiss-cannon-turbotwist-124', brand: 'Weiss Cannon', model: 'TURBOTWIST 124', type: 'ポリエステル', gauge: '1.24mm', gaugeNum: 1.24, length: '12m', color: 'ホワイト', year: 2024, form: 'both', concept: '特許取得のねじれ構造でギア効果を生み出すスピン強化ポリ', searchKeyword: 'Weiss Cannon TURBOTWIST 124' },
  { id: 'weiss-cannon-mosquito-bite-116', brand: 'Weiss Cannon', model: 'MOSQUITO BITE 116', type: 'ポリエステル', gauge: '1.16mm', gaugeNum: 1.16, length: '12m', color: 'ブラック', colors: ['ブラック', 'スカイブルー'], year: 2024, form: 'both', concept: '1.16mmの超極細ポリ・鋭いスピンと繊細なコントロールの最先端モデル', searchKeyword: 'Weiss Cannon MOSQUITO BITE 116' },
  ...
  { id: 'toalson-asterista-armored-125', brand: 'Toalson', model: 'ASTERISTA ARMORED 125', type: 'ナイロン', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'ブラック', colors: ['ブラック', 'ホワイト', 'イエロー'], year: 2024, form: 'both', concept: '耐摩耗糸ラッピング+八角形成形・ポリに近い切断耐久性とスピンを持つモノフィラメント', searchKeyword: 'トアルソン ASTERISTA ARMORED アスタリスタ アーモード 125' },
  ...
  // ========== Prince (追加分) ==========
  { id: 'prince-vortex-125', brand: 'Prince', model: 'VORTEX 17', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'ブラック', colors: ['ブラック', 'レッド'], year: 2024, form: 'both', concept: '成形断面でスピン性能を強化した新世代Princeポリ', searchKeyword: 'プリンス VORTEX 17 125' },
  ...
  { id: 'prince-tour-xc-127', brand: 'Prince', model: 'TOUR XC 16L', type: 'ポリエステル', gauge: '1.27mm', gaugeNum: 1.27, length: '12m', color: 'ブラック', colors: ['ブラック', 'イエロー'], year: 2024, form: 'both', concept: '滑らかなコーティングでスピンとコントロールを両立するコポリ', searchKeyword: 'プリンス TOUR XC 16L 127' },
  { id: 'prince-tour-xp-125', brand: 'Prince', model: 'TOUR XP 17', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'ブラック', colors: ['ブラック', 'グリーン', 'レッド'], year: 2024, form: 'both', concept: 'サーモポリ技術でコントロールに反発感を融合したPrince独自のパワーポリ', searchKeyword: 'プリンス TOUR XP 17 125' },
  ...
  { id: 'dunlop-explosive-speed-125', brand: 'Dunlop', model: 'EXPLOSIVE SPEED 125', type: 'ポリエステル', gauge: '1.25mm', gaugeNum: 1.25, length: '12m', color: 'ブルー', colors: ['ブルー', 'イエロー', 'ブラック'], year: 2024, form: 'both', concept: '丸断面の高反発ポリ・余分なバイト感を抑え球速を最大化', searchKeyword: 'ダンロップ EXPLOSIVE SPEED 125' },
  ...
  { id: 'dunlop-synthetic-tough-130', brand: 'Dunlop', model: 'SYNTHETIC TOUGH 130', type: 'ナイロン', gauge: '1.30mm', gaugeNum: 1.30, length: '12m', color: 'ホワイト', colors: ['ホワイト', 'ブラック', 'ピンク'], year: 2024, form: 'both', concept: '太コアの定番モノフィラメント・切断耐久性とコスパに優れるエントリーナイロン', searchKeyword: 'ダンロップ SYNTHETIC TOUGH 130 ナイロン' },
